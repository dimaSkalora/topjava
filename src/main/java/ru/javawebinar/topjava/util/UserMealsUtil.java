...
public class UserMealsUtil {
    public static void main(String[] args) {
        List<UserMeal> mealList = Arrays.asList(
                ...
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 30,20,0), "Ужин", 550),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31,10,0), "Завтрак", 500),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31,13,0), "Обед", 50),
                new UserMeal(LocalDateTime.of(2015, Month.MAY, 31,20,0), "Ужин", 1010)
        );
